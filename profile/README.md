...
- [Agent Threat Matrix](https://github.com/opena2a-standards/agent-threat-matrix): tactics and techniques for attacks on AI agent systems. 57 techniques across 9 tactics, mapped to MITRE, ATLAS, and OWASP. MITRE submission in flight.
...
- [ATX Conformance](https://github.com/opena2a-standards/atx-conformance): reference verifiers and fixtures for ATX v1.0.
